...
- Quando l’admin archivia un’intera edizione di corso o laboratorio, il sistema salva prima lo stato `Annullato`, rimuove l’evento Calendar e avvisa via email soltanto i partecipanti confermati e non archiviati. Indirizzi mancanti o invii falliti restano visibili all’admin e non ripristinano l’edizione; ripetere l’archiviazione non reinvia le comunicazioni.
