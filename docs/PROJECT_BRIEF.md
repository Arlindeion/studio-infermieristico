...
Il sito deve diventare la vetrina autorevole e il centro operativo leggero di S.C. Studio Infermieristico. Deve sostenere il lancio coordinato dell'identità digitale, dei contenuti social e della consulenza del sonno, senza trasformare lo studio in un'attività dipendente da grandi volumi o automazioni premature.

L'obiettivo del lancio non è vendere tutto immediatamente, ma aumentare il valore percepito dell'offerta e generare contatti qualificati.

## Attività

- Sede: Montesilvano, con attività sul territorio di Pescara e provincia.
- Operativa da gennaio 2026.
- Selene Campetta gestisce direttamente l'attività infermieristica e coordina i servizi per famiglie.
- Alcuni corsi coinvolgono professionisti esterni.
...
S.C. Studio Infermieristico è la sede e il contenitore professionale. Per le famiglie il riferimento umano è Selene: una professionista sanitaria competente, concreta e capace di parlare ai genitori in modo comprensibile.

La percezione da ottenere nei primi secondi è:
...
Questi dati sono contesto gestionale. Non devono essere pubblicati o modificati automaticamente.

| Servizio | Prezzo di riferimento | Frequenza/capienza | Note |
|---|---:|---|---|
| BLSD | 60-75 € a persona | Circa mensile; classe standard fino a 10 | Sono state gestite anche 14 persone con due istruttori. I manichini sono già ammortizzati. |
| Disostruzione pediatrica e tagli sicuri | 35 € singolo; 60 € coppia | Circa mensile; abitualmente 6-8, massimo indicativo 10 | Corso rivolto a genitori e caregiver. |
...
- Nonni e caregiver.
- Aziende e gruppi interessati a BLSD o corsi dedicati.
- Farmacie, medici, pediatri, associazioni e realtà locali come possibili segnalatori o partner.
...
- La domanda per primo soccorso, attività per l'infanzia e corso nascita è reale.
- Sono già arrivate richieste per la consulenza del sonno, ma il servizio deve ancora essere validato sistematicamente.
- L'obiezione al prezzo delle prestazioni infermieristiche è anche culturale: alcune persone confrontano impropriamente il servizio privato con prestazioni coperte dal Servizio sanitario o affidate a personale non sanitario.
- Esistono fotografie reali di corsi e attività.
- Il corso di accompagnamento alla nascita dispone di feedback spontanei; le testimonianze possono essere usate in forma anonima solo dopo autorizzazione.
- Il canale diretto attuale è soprattutto un gruppo WhatsApp utilizzato per inviare le locandine.
- Non esiste ancora una mailing list strutturata.

## Relazioni territoriali

Relazioni e collaborazioni segnalate, con diverso livello di maturità:

- Altamedica per analisi genetiche;
- azienda agricola Colle Rosa;
- Farmacia Russo di Montesilvano;
- medici e pediatri che inviano saltuariamente pazienti;
- laboratorio analisi locale per prelievi domiciliari;
- associazione Gigi la Giraffa per possibili progetti scolastici, ancora in fase embrionale.

Non presentare una relazione come partnership strutturata se non è stata formalizzata.

## Principi decisionali

- Chiarezza prima della quantità di servizi mostrati.
- Fiducia e appropriatezza prima della pressione commerciale.
- Test manuale prima dell'automazione.
- Contatti qualificati prima delle vendite immediate.
- Crescita sostenibile prima del volume.
- Nessuna promessa sanitaria o comportamentale garantita.
