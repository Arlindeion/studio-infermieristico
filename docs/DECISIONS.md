...
- Conseguenze: il form `/prenota` ripropone le stesse quattro tipologie nel selettore e mostra durante la compilazione un riepilogo con prestazione, categoria e tariffa indicativa in studio. Ogni prestazione selezionabile blocca uno slot uniforme di 30 minuti; le prestazioni a domicilio restano fuori dalla prenotazione diretta e richiedono valutazione manuale; tariffe variabili, materiali, distanza e prescrizione sono chiariti prima dell’azione. Il filtro apre soltanto le tipologie con risultati e comunica il numero di corrispondenze.
